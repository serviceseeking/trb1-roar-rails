...
require 'trb1-roar/rails/responder'
require 'trb1-roar/rails/formats'
...
module Trb1::Roar::Rails
  module ControllerAdditions
    ...
    included do
      ...
      self.responder = Trb1::Roar::Rails::Responder
    end
  ...
  private
    ...
    def _resource_or_body(resource)
      resource.is_a?(Trb1::Roar::Rails::Responder::Response) ? resource.body : resource
    end
